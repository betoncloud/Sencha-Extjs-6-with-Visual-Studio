...
folder are mapped to the application's root namespace, 'ExtApplication2'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "ExtApplication2"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ExtApplication2' in the same way
as `"ExtApplication2/sass/src"`.
